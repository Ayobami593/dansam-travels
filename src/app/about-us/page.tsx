  ...
  return (
    <Layout>
      <div className="font-suse md:text-lg text-base space-y-4">
        <div>an image should go in here</div>
        ...
        <div className="flex items- flex-col md:flex-row gap-4">
          <div className="text-center shadow-md bg-white rounded-md flex-1 p-4 h-full">
            <p className="font-bold font-mulish">Our Mission</p>
            <p>
          ...
          <div className="text-center shadow-md bg-white rounded-md flex-1 p-4 h-full">
            <p className="font-bold font-mulish">Our Vision</p>
            <p className="">
        ...
        <div>
          <p className="text-center font-bold font-mulish">
            About the Founder/CEO
          </p>
          <div className="flex gap-4">
            <p className="flex-1">
              Ayobami Samuel is a transformative leader, seamlessly merging the
              worlds of travel and education to foster global understanding and
              growth. As the founder of DanSam Travels & Educonsult, Samuel
              crafts immersive travel experiences that go beyond sightseeing,
              bridging cultural divides and inspiring new perspectives in
              travelers. He believes that firsthand cultural exchange is a
              powerful catalyst for personal and intellectual development. As an
              education consultant, Samuel empowers both educators and learners.
              He works with educational institutions to develop innovative
              programs that promote academic excellence and equip students with
              the skills they need to thrive in a globalized world. He also
              provides personalized guidance to students, helping them navigate
              the complexities of international education and achieve their
              academic aspirations. With a unique blend of industry expertise, a
              deep understanding of cultural dynamics, and a genuine passion for
              lifelong learning, Ayobami Samuel continues to innovate and
              inspire, shaping the future of travel and education, one
            ...
            <p className="flex-1">
              ...
              shaping his leadership style and innovative vision for travel and
              education.
            </p>
          </div>
        </div>
